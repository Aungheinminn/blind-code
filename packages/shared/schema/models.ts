...
// Placeholder GPT-5.6 IDs (Luna/Terra/Sol) — swap for real OpenAI IDs once
// they're published. Claude and Gemini IDs are real.
...
export const isTierModel = (id: string): boolean =>
  TIER_MODELS.some((m) => m.id === id);
